    ...
    public class TableControl : UserControl
    {
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            using (SolidBrush textBrush = new SolidBrush(Color.White))
            {
                ...
                g.DrawString(TableDefinition.Name, headerFont, textBrush, new System.Drawing.Rectangle(0, 0, Width, HeaderHeight), sf);
            }
        ...
        private void TableControl_Load(object sender, EventArgs e)
        {
            ...
            if(frm != null)
            {
                ZidUtilities.CommonCode.Win.Controls.ThemeManager themeManager = new ZidUtilities.CommonCode.Win.Controls.ThemeManager();
                themeManager.ParentForm = frm;
